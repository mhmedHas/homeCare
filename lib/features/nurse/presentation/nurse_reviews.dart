...
class _NurseReviewsScreenState extends State<NurseReviewsScreen> {
  ...
  double get _average {
    ...
    return _reviews.fold<int>(0, (sum, review) => sum + review.rating) / _reviews.length;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [IconButton(onPressed: _loadReviews, icon: const Icon(Icons.refresh))],
      ),
          ...
          children: [
            ...
            if (_reviews.isEmpty)
              const Padding(
                ...
                child: Center(child: Text('لسه مفيش تقييمات')),
              )
            else
