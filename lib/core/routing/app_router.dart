...
class AuthStateNotifier extends ChangeNotifier {
  AuthStateNotifier() { FirebaseAuth.instance.authStateChanges().listen((_) => notifyListeners()); }
}
final authNotifier = AuthStateNotifier();

final GoRouter appRouter = GoRouter(
  initialLocation: '/splash', debugLogDiagnostics: true, refreshListenable: authNotifier, redirect: _redirectLogic,
  routes: [
    ...
    ShellRoute(builder: (_, __, child) => ClientShell(child: child), routes: [
    ...
    ShellRoute(builder: (_, __, child) => NurseShell(child: child), routes: [
